...
class RectangleSplittingSolver(BiobjectiveSolver):
    ...
    def solve(self):
        ...
        try:
            ...
            heapq.heappush(pq, (-RectangleSplittingSolver._calculate_rectangle_area(rectangle), rectangle, r_t, r_b, z_t.hash, z_b.hash))
            self._solutions.append(z_t)
            self._solutions.append(z_b)

            while pq:

                area, b, warm_t, warm_b, z1_hash, z2_hash = heapq.heappop(pq)
                print "\n\nCurrent Rectangle: ",b,"\n\n"
                ...
                if z1_hat.hash != z2_hash:
                    ...
                    heapq.heappush(pq, (-RectangleSplittingSolver._calculate_rectangle_area(rec1_hat), rec1_hat, r1_hat, warm_b, z1_hat.hash, z2_hash))
                ...
                if z2_hat.hash != z1_hash:
                    ...
                    heapq.heappush(pq, (-RectangleSplittingSolver._calculate_rectangle_area(rec2_hat),
                                        rec2_hat, warm_t, r2_hat, z1_hash, z2_hat.hash))
    ...
    def approximate(self, eps=0.05):
        ...
        try:
            ...
            heapq.heappush(pq, (-RectangleSplittingSolver._calculate_rectangle_area(init_rectangle),
                                init_rectangle, r_t, r_b, z_t.hash, z_b.hash))
            ...
            while pq:
                ...
                if z1_hat.hash != z2_hash:
                    ...
                    heapq.heappush(pq, (-RectangleSplittingSolver._calculate_rectangle_area(rec1_hat),
                                        rec1_hat, r1_hat, warm_b,z1_hat.hash, z2_hash))
                else:
                    proof_empty = True
